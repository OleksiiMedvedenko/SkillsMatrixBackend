...
namespace CompetencyMatrixAPI.Controllers
{
    ...
    public class AuditController : ControllerBase
    {
        ...
        {
            var data = await _auditService.GetActualAreaAuditsDatesAsync(areaId);
        ...
        {
            var data = await _auditService.GetActualAreaAuditsLevelAsync(areaId);
            return StatusCode(StatusCodes.Status200OK, JSONSerialization.ConvertToJSON(data));
        }
        ...
        {
            var data = await _auditService.GetFutureAreaAuditsDatesAsync(areaId);
            return StatusCode(StatusCodes.Status200OK, JSONSerialization.ConvertToJSON(data));
        }
        ...
        {
            var data = await _auditService.GetAuditsAsync();
            return StatusCode(StatusCodes.Status200OK, JSONSerialization.ConvertToJSON(data));
        }
        ...
        {
            var data = await _auditService.GetPersonalCompetenceAsync(employeeId, departmentId);
        ...
        {
            var data = await _auditService.ReadAuditNotificationAsync(auditId);
        ...
        public async Task<IActionResult> UpdateAuditInfoPost(UpdateAuditModel? newCompetency)
        {
            ...
            var result = await _auditService.UpdateAuditInfoAsync(newCompetency);
        ...
        {
            var data = await _auditService.GetDepartmentSoonAuditsAsync(departmentId);
            return StatusCode(StatusCodes.Status200OK, JSONSerialization.ConvertToJSON(data));
        }
        ...
        {
            var data = await _auditService.GetDepartmentFutureAuditsAsync(departmentId);
            return StatusCode(StatusCodes.Status200OK, JSONSerialization.ConvertToJSON(data));
        }
        ...
        {
            var data = await _auditService.GetValuationAreaReportAsync(areaId);
            return StatusCode(StatusCodes.Status200OK, JSONSerialization.ConvertToJSON(data));
        }
        ...
        {
            var data = await _auditService.GetAuditCompetenceForEmployeeAsync(employeeId, areaId);
            return StatusCode(StatusCodes.Status200OK, JSONSerialization.ConvertToJSON(data));
        }
        ...
        public async Task<IActionResult> CreateAuditTypePost(ManagerAuditTypeModel? audit)
        {
            ...
            var result = await _auditService.CreateAuditTypeAsync(audit);
            return StatusCode(StatusCodes.Status202Accepted, JSONSerialization.ConvertToJSON(result));
        }
        ...
        public async Task<IActionResult> UpdateAuditType(ManagerAuditTypeModel? audit)
        {
            ...
            var result = await _auditService.UpdateAuditTypeAsync(audit);
            return StatusCode(StatusCodes.Status202Accepted, JSONSerialization.ConvertToJSON(result));
        }
    }
}
