...
namespace CompetencyMatrixAPI.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        {
            var data = await _employeeAsyncService.GetEmployeeAsync(employeeId);
        ...
        {
            var data = await _employeeAsyncService.GetEmployeesAsync();
        ...
        public async Task<IActionResult> CreateEmployeePost(EmployeeCreateModel? employee)
        {
            ...
            var result = await _employeeAsyncService.CreateEmployeeAsync(employee);
        ...
        public async Task<IActionResult> UpdateEmployee(UpdateEmpoyeeModel? employee)
        {
            ...
            var result = await _employeeAsyncService.UpdateEmployeeAsync(employee);
            return StatusCode(StatusCodes.Status201Created, JSONSerialization.ConvertToJSON(result));
        }
        ...
        {
            var data = await _employeeAsyncService.DeactivateEmployeeAsync(employeeId);
        ...
        {
            var data = await _employeeAsyncService.ActivateEmployeeAsync(employeeId);
            return StatusCode(StatusCodes.Status202Accepted, JSONSerialization.ConvertToJSON(data));
        }
        ...
        {
            var data = await _employeeAsyncService.GetEmployeeByDepartmentAsync(departmentId);
            return StatusCode(StatusCodes.Status202Accepted, JSONSerialization.ConvertToJSON(data));
        }
    }
}
