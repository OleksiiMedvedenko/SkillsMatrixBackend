...
namespace Models.Model
{
    public class Audit
    {
        ...
        public bool? IsIncludeLink { get; private set; }


        public Area? Area { get; private set; }

        public Tuple<string?, short?>? CurrentAuditInfo { get; private set; }
        ...
        public Audit(int? auditId, (DateTime? date, short? level)? currentAudit)
        {
            AuditId = auditId;
        ...
        public Audit(int? id, string? name, Area? area, decimal? importance, bool? isIncludeLink)
        {
            AuditId = id;
            Name = name;
            Area = area;
        ...
        public Audit(int? id, string? name, Area? area, (DateTime? date, short? level)? currentAudit, (DateTime? date, short? level)? lastAudit = null, decimal? importance = null)
        {
            this.id = id;
            AuditId = id;
            Name = name;
