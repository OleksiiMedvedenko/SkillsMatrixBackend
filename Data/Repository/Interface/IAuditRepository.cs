...
namespace Data.Repository.Interface
{
    public interface IAuditRepository
    {
        ...
        Task<ExternalDataResultManager<bool>> CreateAuditTypeAsync(ManagerAuditTypeModel? audit);
        Task<ExternalDataResultManager<bool>> UpdateAuditTypeAsync(ManagerAuditTypeModel? audit);
        
        Task<ExternalDataResultManager<bool>> UpdateAuditInfoAsync(UpdateAuditModel? newCompetency);
